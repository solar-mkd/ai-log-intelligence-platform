...
> Resolved since first draft: the embedding model (now ADR-018) and the chat/generation LLM (Mistral via Ollama, swappable) were previously deferred here and have since been decided.
